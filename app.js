...
app.get('/aboutuspage', (req, res) => {
  res.render('aboutuspage'); // Example route for about us page
});
...
app.post('/Registration', (req, res) => {
  ...
  app.get('/newsproject', (req, res) => {
  res.render('newsproject'); // Render newsproject.pug
});
  
  app.get('/aboutuspage', (req, res) => {
    res.render('aboutuspage'); // Render aboutus.pug
  });
